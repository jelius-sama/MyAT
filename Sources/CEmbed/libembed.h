...
//
extern char* GetEmbeddedAsset(char* pathPtr);
...
//
extern char* GetEmbeddedAssetWithInfo(char* pathPtr);

// GetEmbeddedAssetData retrieves just the raw data
//
extern char* GetEmbeddedAssetData(char* pathPtr, int* sizeOut);

// GetEmbeddedAssetMimeType retrieves just the MIME type
//
extern char* GetEmbeddedAssetMimeType(char* pathPtr);

// GetEmbeddedAssetSize retrieves just the size
//
extern int GetEmbeddedAssetSize(char* pathPtr);

// AssetExists checks if an asset exists in the embedded FS
//
extern int AssetExists(char* pathPtr);
extern char* ListEmbeddedAssets();
